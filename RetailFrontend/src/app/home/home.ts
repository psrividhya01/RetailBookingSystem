...
export class Home implements OnInit {
  ...
  slides = [
    {
      image: 'assets/pizza-slide.jpg',
      title: 'Midnight Cravings?',
      sub: 'Flat 10% Off on all orders after 10 PM',
    },
    {
      image: 'assets/mania-slide.jpg',
      title: 'The Pizza Mania',
      sub: 'Experience the cripsiest pizza in town',
    },
    {
      image: 'assets/drinks-slide.jpg',
      title: 'Stay Chilled',
      sub: 'Buy 1 Get 1 Free on all Cold Drinks',
    },
  ];
